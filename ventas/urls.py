...
from .views import registrar_venta, inicio_turno, agregar_al_carrito, ver_carrito, finalizar_venta, cerrar_turno, buscar_productos, eliminar_item_carrito, actualizar_cantidad_carrito
